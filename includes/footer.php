                ...
                <div class="col-md">
                    <div class="ftco-footer-widget mb-4">
                        ...
                        <div class="block-21 mb-4 d-flex">
                            <a class="img mr-4 rounded" style="background-image:url(assets/images/ximage_1.jpg.pagespeed.ic.6nutUC1128.jpg)"></a>
                            <div class="text">
                        ...
                        <div class="block-21 mb-4 d-flex">
                            <a class="img mr-4 rounded" style="background-image:url(assets/images/ximage_2.jpg.pagespeed.ic.HhFRahl7c7.jpg)"></a>
                            <div class="text">
                                <h3 class="heading"><a href="#">Even the all-powerful Pointing has no control about</a></h3>
                                <div class="meta">
                                    <div><a href="#"></span> Oct. 16, 2019</a></div>
                    ...
                    <div class="ftco-footer-widget mb-4">
                        ...
                        <div class="block-23 mb-3">
                            <ul>
                                ...
                                <li><a href="#"><span class="icon icon-envelope"></span><span class="text"><span class="__cf_email__" data-cfemail="660f080009261f09131402090b070f084805090b">[email&#160;protected]</span></span></a></li>
                            </ul>
                        </div>
                    </div>
                </div>
